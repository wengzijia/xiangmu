...
dsy.add('0_0', ['北京市']);
dsy.add('0_1_0', ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '滨海区', '宁河区', '静海区', '蓟州区']);
dsy.add('0_1', ['天津市']);
dsy.add('0_2_0', ['黄浦区', '徐汇区', '长宁区', '静安区', '普陀区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '奉贤区', '崇明区']);
dsy.add('0_2', ['上海市']);
...
dsy.add('0_10_11', ['锡山区', '惠山区', '滨湖区', '梁溪区', '新吴区',  '江阴市', '宜兴市']);
dsy.add('0_10_12', ['虎丘区', '吴中区', '相城区', '姑苏区', '吴江市', '昆山市', '太仓市', '常熟市', '张家港市']);
...
dsy.add('0_14_1', ['浔阳区', '庐山区', '濂溪区', '瑞昌市', '九江县', '沙河街镇', '武宁县', '新宁镇', '修水县', '义宁镇', '永修县', '涂埠镇', '德安县', '蒲亭镇', '星子县', '南康镇', '都昌县', '都昌镇', '湖口县', '双钟镇', '彭泽县', '龙城镇']);
...
dsy.add('0_15_8', ['环翠区', '荣成市', '乳山市', '文登市', '威海火炬高技术产业开发区', '威海经济技术开发区', '威海临港经济技术开发区', '威海南海新区']);
...
dsy.add('0_19_1', ['福田区', '罗湖区', '南山区', '宝安区', '龙岗区', '盐田区', '龙华区', '光明新区', '大鹏新区','坪山区']);
...
dsy.add('0_19_11', ['莞城街道','南城街道','东城街道','万江街道','石龙镇', '石排镇', '茶山镇', '企石镇', '桥头镇', '东坑镇', '横沥镇', '常平镇', '虎门镇', '长安镇', '沙田镇', '厚街镇', '寮步镇', '大岭山镇', '大朗镇', '黄江镇', '樟木头镇', '谢岗镇', '塘厦镇', '清溪镇', '凤岗镇', '麻涌镇', '中堂镇', '高埗镇', '石碣镇', '望牛墩镇', '洪梅镇', '道滘镇']);
dsy.add('0_19_12', ['香洲区', '斗门区', '金湾区']);
dsy.add('0_19_13', ['黄圃镇', '南头镇', '东凤镇', '阜沙镇', '小榄镇', '东升镇', '古镇镇', '横栏镇', '三角镇', '民众镇', '南朗镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇', '石岐街道','东区街道','西区街道','南区街道','五桂山街道','火炬开发区街道']);
...
dsy.add('0_21_2', ['文昌市', '琼海市', '万宁市', '五指山市', '东方市', '三沙市', '儋州市', '临高县', '临城镇', '澄迈县', '金江镇', '定安县', '定城镇', '屯昌县', '屯城镇', '昌江黎族自治县', '石碌镇', '白沙黎族自治县', '牙叉镇', '琼中黎族苗族自治县', '营根镇', '陵水黎族自治县', '椰林镇', '保亭黎族苗族自治县', '保城镇', '乐东黎族自治县', '抱由镇']);
...
dsy.add('0_33_0', ['中正区', '万华区', '大同区', '中山区', '松山区', '大安区', '信义区', '内湖区', '南港区', '士林区', '北投区', '文山区']);
dsy.add('0_33_1', ['板桥区', '汐止区', '新店区', '永和区', '中和区', '土城区', '树林区', '三重区', '新庄区', '芦洲区', '瑞芳区', '三峡区', '莺歌区', '淡水区', '万里区', '金山区', '深坑区', '石碇区', '平溪区', '双溪区', '贡寮区', '坪林区', '乌来区', '泰山区', '林口区', '五股区', '八里区', '三芝区', '石门区']);
dsy.add('0_33_2', ['桃园区', '中坜区', '平镇区', '八德区', '杨梅区', '芦竹区', '大溪区', '龙潭区', '龟山区', '大园区', '观音区', '新屋区', '复兴区']);
dsy.add('0_33_3', ['中区', '东区', '南区', '西区', '北区', '北屯区', '西屯区', '南屯区', '太平区', '大里区', '雾峰区', '乌日区', '丰原区', '后里区', '潭子区', '大雅区', '神冈区', '石冈区', '东势区', '新社区', '和平区', '大肚区', '沙鹿区', '龙井区', '梧栖区', '清水区', '大甲区', '外埔区', '大安区']);
dsy.add('0_33_4', ['中西区', '东区', '南区', '北区', '安平区', '安南区', '永康区', '归仁区', '新化区', '左镇区', '玉井区', '楠西区', '南化区', '仁德区', '关庙区', '龙崎区', '官田区', '麻豆区', '佳里区', '西港区', '七股区', '将军区', '学甲区', '北门区', '新营区', '后壁区', '白河区', '东山区', '六甲区', '下营区', '柳营区', '盐水区', '善化区', '大内区', '山上区', '新市区', '安定区']);
dsy.add('0_33_5', ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '大寮区', '鸟松区', '林园区', '仁武区', '大树区', '大社区', '冈山区', '路竹区', '桥头区', '梓官区', '弥陀区', '永安区', '燕巢区', '阿莲区', '茄萣区', '湖内区', '旗山区', '美浓区', '内门区', '杉林区', '甲仙区', '六龟区', '茂林区', '桃源区', '那玛夏区']);
dsy.add('0_33', ['台北市', '新北市', '桃园市', '台中市', '台南市', '高雄市']);

export function getProvince() {
  const citys = dsy.Items['0'];
  return citys;
};

export function getCity(id) {
  const citys = dsy.Items['0_' + id];
  return citys;
};
export function getAreaId(type, name, parentId) {
  ...
  if (type === 'province') {
    ...
    const cityList = getCity(parentId);
    ...
    const countyList = getCity(parentId);
    for (let i = 0; i < countyList.length; i++) {
      if (name === countyList[i]) {
        return parentId + '_' + i;
      }
    }
  }
...
export function getAreaName(type, id) {
  if (type === 'province') {
    const provinceList = getProvince();
    return provinceList[parseInt(id)];
  } else if (type === 'city') {
    const ids = id.split('_');
    return getCity(ids[0])[ids[1]];
  } else {
    const ids = id.split('_');
    return getCity(ids[0] + '_' + ids[1])[ids[2]];
  }
};
