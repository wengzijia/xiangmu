<template>
  <div class="component-upload-image">
    ...
    <!-- 上传提示 -->
    <div class="el-upload__tip" v-if="showTip&&!disabled" style="width:290px;">
      请上传
...
const baseUrl = BASE_FILE_URL;
const uploadImgUrl = BASE_UPLOAD_FILE_URL() // 上传文件服务器地址
const headers = ref({ 
  ...
  if (val) {
    ...
    fileList.value = list.map(item => {
      if (typeof item === "string") {
        item = { name: item, url: BASE_FILE_URL+item };
      }
      return item;
    });
  } else {
