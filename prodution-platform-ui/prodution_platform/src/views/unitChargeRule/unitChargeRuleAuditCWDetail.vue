    ...
    <div class="unitChargeDetailContainer">
        ...
        <div class="unitChargeDetailBox">
            <div class="leftContainer">
                ...
                <div class="tableBox">
                    <uniPriceRuleTable :tableData="ruleTableData" :hiddenColumn="chargingRuleInfo.attributeId !== '2'" :attributeId="chargingRuleInfo.attributeId">
                    </uniPriceRuleTable>
                </div>
...
const toPage = () => {
    let pathInfo = router.resolve({ //使用resolve
        ...
        query: {
            ...
            detail: "/unitChargeRule/unitChargeRuleAuditCWDetail"
        }
    })
...
const confirm = (formEl) => {
    ...
    formEl.validate(async (valid, fields) => {
        if (valid) {
            ...
            if (code == '000000') {
                let channel = new BroadcastChannel("channel-unitChargeRuleListAuditCWB");
