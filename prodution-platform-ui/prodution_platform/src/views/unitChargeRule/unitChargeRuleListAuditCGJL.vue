    ...
    <div class="commonTableListBox">
        ...
        <div class="content_box">
            <div class="table_box" id="getTableHeight">
                <el-table :data="tableData" border :height="tableHeight" ref="tableRef"
...
<script name="unitChargeRuleListAuditCGJL" setup>
...
onMounted(() => {
    ...
    channel = new BroadcastChannel("channel-unitChargeRuleListAuditCGJL");
...
const toValidDetail = (row) => {
    // window.open(`/unitChargeRule/unitChargeRuleAuditCGJLDetail?id=${row.id}`, '_blank')
