                ...
                <div class="select_group">
                    <el-form :inline="true" :model="defaultValue" class="demo-form-inline" style="width:100%;">
                        <el-form-item label="加工商">
                            <el-select v-model="defaultValue.manufacturerName" @change="searchChange" :filter-method="searchFilter" clearable filterable placeholder="请输入"
                            no-match-text="无匹配项">
                ...
                <div class="select_group">
                    <el-form :inline="true" :model="selectData" class="demo-form-inline" style="width:100%;">
                        ...
                        <el-form-item label="状态" prop="ruleStatus">
                            <el-select v-model="selectData.ruleStatus" placeholder="全部" @change="switchingData">
                ...
                <el-table :data="tableData" :span-method="objectSpanMethod" ::header-cell-style="{ color: '#333' }" border
                    ...
                    <el-table-column prop="ruleStatus" label="状态" width="120" align="center" >
                        <template #default="scope">
                            <div style="color:#666;" :style="colorMap[scope.row.ruleStatus]">{{
                                statusList[scope.row.ruleStatus].label }}</div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作" width="120" align="center">
                        <template #default="scope">
                            <el-button class="edit_buttom" size="small"
                                @click="handleEditUser(scope.$index, scope.row)">查看</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
...
<script name="PriceRuleList" setup>
...
import { getBillRulePage } from "@/api/modules/unitChargeRule";
 ...
 */
 function getTableList() {
    ...
    getBillRulePage(selectData.value).then(res => {
        console.log(res)
...
const handleEditUser = (index, row) => {
    ...
    // window.open(`/financial/chargingDetail?id=${row.id}&type=1`, '_blank')
