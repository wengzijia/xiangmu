...
Page({
    ...
    onLoad: function (option) {
      console.log('option', option, app.globalData.isLogin);
        if (!app.globalData.isLogin) {
            ...
            wx.redirectTo({
                url: '../../../../login/index?data=' + option.data + '&type=shareOrder4',
                complete: () => {
                    wx.hideLoading()
                }
            })
        ...
        this.setData({
            ordersn: option.data,
            source: option.type,//'11111111111111'
        })
        try {
            this.setData({
                xhToken: wx.getStorageSync('token')
    ...
    onShow: function () {
        ...
        this.onShareAppMessage = () => {
            ...
            return {
                title: '确认文件',
                path: 'pages/personageCenter/allPrintingOrder/share/orderDetails/index?data=' + JSON.stringify(obj),
            }
        }
    },
    //查看物流
  ...
  previewImg:function(e){
    ...
    getOrderDetails: async function (e) {
        ...
        console.log('sdfsdfsdfsdfsdf',this.data.ordersn);
        this.data.ordersn
