<template>
  <div class="guigeRt guigeRtWrap">
    <div class="">
      <h2 class="guigeRtH2">精装盒-{{ title.name }}报价</h2>
      <div class="geRtList">
        <h4>打样店地址</h4>
        <div class="dayC7">
    ...
    <div class="geRtList">
      <p class="flex geRtotal">
        总计:<span id="price_total">￥{{ priceFormData.price ? priceFormData.price : 0 }}</span>
      </p>
