  ...
  <div>
    ...
    <el-main v-loading="loading" v-else>
      <div class="comBox">
        <div class="downBox">
          <ul>
            <li v-for="(item, index) in goodsList" :key="index" :class="index + '' == imgindex ? 'curr' : ''" @mouseenter="imageOver(index)" @mouseleave="imageLeave(index)" @click="linkDetailUrl(item)">
  ...
  methods: {
    ...
    initDetailUrl() {
      ...
      if (strEquals(this.cateId, '1')) {
        //卡盒
        url = '/cutter/CardNew';
        document.title = '卡纸盒刀模图_纸盒刀模图_彩盒刀模图-傲彩';
        ...
        //微坑
        url = '/cutter/CardNew';
        document.title = '坑纸盒刀模图_纸盒刀模图_彩盒刀模图-傲彩';
