            ...
            <div class="spec-preview">
              <span class="jqzoom">
                ...
                <div v-if="frame_show" style="line-height: 0vw;">
                  <iframe name="knife_3d" src="http://localhost:8080/webgl_loader_obj.html" class="knife_3d" id="knife_1" style="width: 842px;height: 578px;"></iframe>
                </div>
              </span>
            </div>
            <!-- 缩略图begin -->
