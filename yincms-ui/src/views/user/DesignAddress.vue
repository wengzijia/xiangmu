<template>
  <div>
    <div class="UP_right_List">打样地址</div>
          ...
          <ul class="wbb1207Addreceiptaddressdiv">
            <li class="wbb1201Receiptaddress wbb1208box fl" v-for="(item, index) in addressList" :key="index">
              <ul class="wbb1201Receiptaddress-ul2">
                ...
                <li>
                  <span class="wbb1201Small1"><img src="@/static/index/user/images/wbb120104.png"/></span>
                  &nbsp;<span class="mobile">{{ item.mobile }}</span
                  >&nbsp;
                  <img src="@/static/index/user/images/login_qq.png" style="margin-left:16px;" width="18" />
...
<script>
import { getMyList, getById, saveOrUpdate, deleteById } from '@/api/users/userDesignAddressApi';
