              ...
              <div class="invoice_Main" v-for="(vo, index) in invoices" :key="index" @mouseenter="changeActive($event)" @mouseleave="removeActive($event)">
                ...
                <ul>
                  ...
                  <div v-if="vo.invoiceType == 0">
                    ...
                    <li v-if="vo.invoiceVo.invoiceAddress">注册地址：{{ vo.invoiceVo.invoiceAddress }}</li>
                    <li v-if="vo.invoiceVo.invoiceMobile">注册电话：{{ vo.invoiceVo.invoiceMobile }}</li>
                    <li v-if="vo.invoiceVo.invoiceBank">开户银行：{{ vo.invoiceVo.invoiceBank }}</li>
                    <li v-if="vo.invoiceVo.invoiceBankcode">银行账户：{{ vo.invoiceVo.invoiceBankcode }}</li>
                  </div>
                  <div v-else>
              ...
              <div>
                <el-form :model="invoiceFromDataZero.invoiceVo" :rules="rules" ref="invoiceForm" label-width="100px" class="demo-ruleForm">
                  ...
                  <el-form-item label="注册地址：" :label-width="formLabelWidth" prop="invoiceAddress">
                    <el-input v-model="invoiceFromDataZero.invoiceVo.invoiceAddress" autocomplete="off"></el-input>
                  </el-form-item>

                  <el-form-item label="注册电话：" :label-width="formLabelWidth" prop="invoiceMobile">
                    <el-input v-model="invoiceFromDataZero.invoiceVo.invoiceMobile" autocomplete="off"></el-input>
                  </el-form-item>

                  <el-form-item label="开户银行：" :label-width="formLabelWidth" prop="invoiceBank">
                    <el-input v-model="invoiceFromDataZero.invoiceVo.invoiceBank" autocomplete="off"></el-input>
                  </el-form-item>

                  <el-form-item label="银行账户：" :label-width="formLabelWidth" prop="invoiceBankcode">
                    <el-input v-model="invoiceFromDataZero.invoiceVo.invoiceBankcode" autocomplete="off"></el-input>
                  </el-form-item>
