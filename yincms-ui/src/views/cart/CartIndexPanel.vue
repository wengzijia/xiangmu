              ...
              <tr v-for="(vo, index) in cartList" :key="index">
                ...
                <td>
                  <template v-if="vo.goodsTag == 1 && (vo.cuttingImages == '' || vo.cuttingImages == null)">
                    ...
                    >
                      <el-button size="small" style="padding: 4px 15px;height: auto;" >上传文件</el-button>
                    </el-upload>
                  </template>
                  <template v-if="vo.goodsTag == 1 && vo.cuttingImages != '' && vo.cuttingImages != null">
                    ...
                    <el-upload
                      ...
                      :on-error="uploadError"
                    >
                      <el-button size="small" style="padding: 4px 15px;height: auto;">重新上传</el-button>
                    </el-upload>
                  </template>
      ...
      priceOfMakeup(data)
        .then(res => {
          ...
          if (res.success) {
            ...
            this.discountedPrice = Math.floor(discountedPrice);
