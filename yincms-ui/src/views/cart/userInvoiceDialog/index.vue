<template>
  <el-dialog title="发票信息" width="850px" :visible.sync="visible" :before-close="handleCloseDialog" style="z-index:3000">
            ...
            <div>
              <el-form :model="invoiceFromDataZero.invoiceVo" :rules="rules" ref="invoiceForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="发票类型：" :label-width="formLabelWidth">
                  <el-radio-group v-model="invoiceFromDataZero.invoiceCategory">
...
<script>
import { getInvoiceByUid, saveOrUpdate, getInvoiceCodeByWord } from '@/api/users/userInvoiceApi';
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          if (this.invoiceType === '1') {
            ...
            if (this.invoiceFromDataZero.invoiceCategory == 0) {
              this.$message({
                type: 'error',
                message: '请选择发票类型!'
              });
