        ...
        <div class="loginTab">
          ...
          <div class="loginTabox" v-if="loginType === 'password'" @keyup.enter="handleSubmit">
            <ul class="loginLs">
              ...
              <li>
                <el-input type="password" v-model="formData.password" @input="inputChange('password')" placeholder="请输入密码">
          ...
          <div class="loginTabox" v-if="loginType === 'sms'">
            <ul class="loginLs">
              ...
              <li>
                <el-input v-model="formData.smsVerifyCode" @input="inputChange('smsVerifyCode')" placeholder="请输入短信验证码">
      ...
      if (this.loginType === 'password') {
        ...
        Login(reqParam).then(res => {
          if (res.success) {
            ...
            _this.$router.replace({ path: '/price/cartIndex?cateId=1&subCateId=15' });
          }
        });
      } else {
        const reqParam = {
