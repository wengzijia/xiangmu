...
*/ (function(e, t) {
        ...
        while ((o = s[n++]) && !e.isPropagationStopped()) {
          ...
          while ((i = o.handlers[a++]) && !e.isImmediatePropagationStopped())
            (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
              ((e.handleObj = i), (e.data = i.data), (r = ((b.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, u)), r !== t && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
        }
  ...
  (function(e, t) {
    ...
    (i = st.selectors = {
      ...
      preFilter: {
        ...
        CHILD: function(e) {
          return (
            (e[1] = e[1].toLowerCase()), 'nth' === e[1].slice(0, 3) ? (e[3] || st.error(e[0]), (e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ('even' === e[3] || 'odd' === e[3]))), (e[5] = +(e[7] + e[8] || 'odd' === e[3]))) : e[3] && st.error(e[0]), e
          );
        },
        PSEUDO: function(e) {
          var t,
        ...
        if (a)
          for (u = s[s.length - 1].ownerDocument, b.map(s, qt), c = 0; a > c; c++)
            ...
            kt.test(o.type || '') &&
                  ...
                  b.contains(u, o) &&
                  (o.src ? b.ajax({ url: o.src, type: 'GET', dataType: 'script', async: !1, global: !1, throws: !0 }) : b.globalEval((o.text || o.textContent || o.innerHTML || '').replace(St, '')));
        l = i = null;
      }
      return this;
    }
      ...
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          ...
          !(
            null == r ||
              ('number' === a && isNaN(r)) ||
              ('number' !== a || b.cssNumber[u] || (r += 'px'), b.support.clearCloneStyle || '' !== r || 0 !== n.indexOf('background') || (l[n] = 'inherit'), s && 'set' in s && (r = s.set(e, r, i)) === t)
          ))
        )
          try {
            l[n] = r;
    ...
    (Wt = function(e, n, r) {
      ...
      return (
        s &&
              ...
              Yt.test(u) && Ut.test(n) && ((i = l.width), (o = l.minWidth), (a = l.maxWidth), (l.minWidth = l.maxWidth = l.width = u), (u = s.width), (l.width = i), (l.minWidth = o), (l.maxWidth = a))),
        u
      );
    }))
  ...
  function nr(e, t, n) {
    ...
    1 === e.nodeType &&
        ...
        ((n.overflow = [d.overflow, d.overflowX, d.overflowY]), 'inline' === b.css(e, 'display') && 'none' === b.css(e, 'float') && (b.support.inlineBlockNeedsLayout && 'inline' !== un(e.nodeName) ? (d.zoom = 1) : (d.display = 'inline-block'))),
    n.overflow &&
        ((d.overflow = 'hidden'),
