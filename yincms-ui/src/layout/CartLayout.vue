<!-- fengjianbo -->
<template>
  <el-container class="login" style="background-color: #f5f5f5;position: relative;">
    <el-header class="header-nav" style="height: auto;">
      <!--修改于2017-0621-->
      <div class="mainNavs">
        <div class="topTilebox" style="position: relative;">
          <div class="container">
...
export default {
  ...
  methods: {
    ...
    setCurrent() {
      ...
      var routePath2 = ['/cart/checkorder', '/cart/checkproof', '/order/requrchaseOrder'];
      if (routePath2.indexOf(path) > -1) {
        this.isCurrent = 2;
      }
      var routePath3 = ['/service/getpay', '/service/getcylpay', '/service/getinvoicepay'];
