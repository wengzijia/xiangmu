        ...
        <div class="downBox">
          ...
          <ul style="margin: 20px 0 0 0">
            <li
              ...
              :key="index"
              :class="index + '' == imgindex ? 'curr' : ''"
              @mouseenter="imageOver(index)"
              @mouseleave="imageLeave(index)"
              @click.stop="$router.push('/cutter/canbodyNew?cateId=10&subCateId='+$route.query.subCateId+'&id=' + item.id)"
            >
