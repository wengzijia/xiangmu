...
<template>
  <div>
      ...
      <div id="imageShow">
        <div class="block">
          <el-carousel height="400px" trigger="click">
            <el-carousel-item v-for="(vo, index) in carouselList" :key="index" :style="'background: url(' + vo + ') no-repeat center;'">
              <!--              <img :src="vo" style="position: absolute;" />-->
              <div v-if="index == 2" class="bantxt">
                <p class="bantxt_p">
                  今日已下
                  <span>{{ CountInfo.orderToday }}</span> 个订单， <span>{{ CountInfo.agentOnline }}</span> 个包装用户在线，累计已有 <span>{{ CountInfo.agentNum }}</span> 个包装用户加入
                </p>
                <div class="bantxt_dv" v-if="!$store.getters.userInfo.id">
    ...
    <div v-if="$store.getters.userInfo.id">
    ...
    <div v-else>
      ...
      <div class="datBox">
        <div class="comBox">
          ...
          <p class="glpt">设计打样、大货生产，一站式包装解决方案就上拼一版</p>
      ...
      <div class="comBox center-tx OEMbox">
        <div class="OEMtitle">
          <h6>拼一版，生产基地</h6>
          <p>拼一版已在<span class="red">广州、深圳、东莞、中山、佛山、江门建立8大生产基地</span></p>
        ...
        <div class="flex comBox">
          <div class="aboutBox">
            ...
            <div class="flex aboutoZ">
              <div class="inforL">
                <h1>关于<span class="red">拼一版</span>，你知道多少？</h1>
                <ul>
              ...
              <ul class="inforR">
                <li>
                  <a href="https://tech.ifeng.com/c/7qFjAmyKom1" target="_blank">
                    <h6>● 拼一版荣获中国印刷业“创新十强”</h6>
                    <p class="txt">拼一版凭借智能包装报价系统、智能包装刀模系统、智能包装拼版系统等行业创新技术，荣获2019年中国印刷业“创新十强”</p>
                    <p class="inforRtime">发布时间：2019-09-25</p>
                  </a>
                </li>
                <li>
                  <a href="http://www.ebrun.com/20180821/293129.shtml" target="_blank">
                    <h6>● 拼一版获1000万元天使投资</h6>
                    <p class="txt">小批量包装印刷供应链电商平台拼一版完成1000万元天使轮融资,本轮融资投资方是顶聚投资,这是国内包装印刷电商行业获得的首次融资。</p>
                    <p class="inforRtime">发布时间：2018-08-21</p>
                  </a>
                </li>
                <li>
                  <a href="http://www.keyin.cn/news/ysqy/201804/04-1110193.shtml" target="_blank">
                    <h6>● 拼一版荣获2018年中国印刷互联网“新锐奖”</h6>
                    <p class="txt">2018中国印刷业互联网创新节暨第六届中国印刷电商年会在北京拉开帷幕，拼一版凭借独特的商业模式与包装行业技术突破，荣获“中国印刷互联网新锐奖”。</p>
...
import { saveOrdersRepurchases } from '@/api/cart/cartApi';
...
export default {
  data() {
    return {
      ...
      listFlipOrderList: [],
      listOrder: [],
      carouselList: [require('../../static/mulindex/img/index/20210129.jpg'), require('../../static/mulindex/img/index/banner00.jpg'), require('../../static/mulindex/img/index/banner0.jpg'), require('../../static/mulindex/img/index/bnner02.jpg')]
    };
  },
  // 方法
  methods: {
