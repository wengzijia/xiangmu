  ...
  <div>
                ...
                <tbody v-for="(order, index) in demandList" :key="index">
                  ...
                  <tr class="tr-th">
                    <td colspan="5">
                      ...
                      >
                      <span style="margin-left:20px;">{{ order.designerInfos.companyname }}:{{ order.designerInfos.contacts }}-{{ order.designerInfos.tel }}</span>
                  ...
                  <tr v-for="(info, index1) in order.proofInfos" :key="index1" class="track57442710364">
                    <td>
                      ...
                      <br /><br />
                      <div class="right_P911672">X{{ info.fnumber }}款</div>
                    </td>
    ...
    <div>
      ...
      >
        ...
        <h2>确认大货适配打样操作声明！</h2>
        <p style="display: block;">尊敬的客户：请您认真检查样品盒型适配效果, 一旦确认适配效果后，非拼一版原因产生的适配问题概不受理,请您确保已经一 一仔细确认。</p>
        <fieldset>
