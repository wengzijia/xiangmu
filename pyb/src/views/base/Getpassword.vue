  ...
  <div class="passBox comBox">
    ...
    <div class="flex passwdMain">
      <div class="passLeft">
        <ul>
          <li>
            <el-input v-model="formData.mobile" placeholder="请输入注册时手机号码">
          ...
          <li>
            <el-input v-model="formData.newPwd" type="password" placeholder="请输入新密码" :show-password="true">
              <template slot="prepend"><div style="width:80px">新密码</div></template>
            </el-input>
          </li>
          <li>
            <el-input v-model="formData.confirmNewPwd" type="password" placeholder="请输入确认新密码" :show-password="true">
      ...
      <div class="passRt">
        <dl class="flex passLog">
          ...
          <dd>已有拼一版账号 <a href="/login" class="red">立即登录</a></dd>
        </dl>
