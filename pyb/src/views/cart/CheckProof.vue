                  ...
                  <div class="layui-col-md12">
                    <div class="layui-card">
                      <div class="opt layui-form">
                        <el-radio v-model="fileNormalization" label="1">允许拼一版对设计文件、刀模文件进行生产规范化修正</el-radio> <br />
            ...
            <ul>
              ...
              <li class="bjrow">
                <div class="totalDv">
                  <label>应付总额：</label>
                  <b class="val">
                    <font class="chktotalmoney">{{ orderGoodInfo.totalAmount }}</font
                    >元
                  </b>
                </div>
              </li>
...
<script>
import { getAddressByUid, getCountCart, commit, updateAddress, setAddresDefault, deleteAddressById, getAddressById } from '@/api/cart/cartCheckProofApi';
