...
function createShapes(){
    ...
    var temp_L1 		= createL1Ruler(temp_Bottom, temp_N);
    ...
    var temp_L2 		= createL2Ruler(temp_Top, temp_W2);
    ...
    //scene.add(temp_W1);
    //scene.add(temp_L2);
    //scene.add(temp_Dust1);
    //scene.add(temp_Dust4);
...
function createL1Ruler(temp_ruler, temp_ruler2){
...
function createL2Ruler(temp_ruler, temp_ruler2){
    ...
    Shape.absarc( L2['L2xF'], L2['L2yF'], 8, 0/180*Math.PI ,180/180*Math.PI, true );
    Shape.lineTo( L2['L2xG'], L2['L2yG'] );
...
function createDust3Ruler(temp_ruler){
    ...
    Dust3['Dust3yA'] = initialy-coo['W2yB'];
    ...
    Dust3['Dust3yJ'] = initialy-coo['Dust3yJ'];
...
function createDust3rRuler(){
    ...
    Shape.absarc( Dust3['Dust3xF'], Dust3['Dust3yF'], 3, 270/180*Math.PI ,360/180*Math.PI, false );
    Shape.lineTo( Dust3['Dust3xF'], Dust3['Dust3yF']);
...
function createDust4Ruler(temp_ruler){
    ...
    Dust4['Dust4yJ'] = initialy-coo['W1yC'];
...
function createDust4lRuler(){
    ...
    Shape.absarc( Dust4['Dust4xE'], Dust4['Dust4yE'], 3, 180/180*Math.PI ,270/180*Math.PI, false );
    Shape.lineTo( Dust4['Dust4xE'], Dust4['Dust4yE']);
...
function createBottomRuler(temp_ruler){
    ...
    Bottom['BottomyB'] = initialy-coo['BottomyB']-pt;
    Bottom['BottomyC'] = initialy-coo['BottomyC']-pt;
    Bottom['BottomyD'] = initialy-coo['BottomyD']-pt;
    Bottom['BottomyE'] = initialy-coo['BottomyE']-pt;
    Bottom['BottomyF'] = initialy-coo['BottomyF']-pt;
    Bottom['BottomyG'] = initialy-coo['BottomyG']-pt;
    Bottom['BottomyH'] = initialy-coo['BottomyH']-pt;
    Bottom['BottomyI'] = initialy-coo['BottomyI']-pt;
...
function createBottomCRuler(temp_ruler, temp_ruler2){
    ...
    BottomC['BottomCyA'] = initialy-coo['BottomCyA']+0.1-pt;
    BottomC['BottomCyB'] = initialy-coo['BottomCyB']-pt;
    BottomC['BottomCyC'] = initialy-coo['BottomCyC']-pt;
    BottomC['BottomCyD'] = initialy-coo['BottomCyD']-pt;
    BottomC['BottomCyE'] = initialy-coo['BottomCyE']-pt;
    BottomC['BottomCyF'] = initialy-coo['BottomCyF']-pt;
    BottomC['BottomCyG'] = initialy-coo['BottomCyG']-pt;
    BottomC['BottomCyH'] = initialy-coo['BottomCyH']+0.1-pt;
...
function createTopRuler(temp_ruler){
    ...
    Top['TopyB'] = initialy-coo['TopyB']+pt;
    Top['TopyC'] = initialy-coo['TopyC']+pt;
    Top['TopyD'] = initialy-coo['TopyD']+pt;
    Top['TopyE'] = initialy-coo['TopyE']+pt;
    Top['TopyF'] = initialy-coo['TopyF']+pt;
    Top['TopyG'] = initialy-coo['TopyG']+pt;
    Top['TopyH'] = initialy-coo['TopyH']+pt;
    Top['TopyI'] = initialy-coo['TopyI']+pt;
    ...
    Shape.lineTo( Top['TopxE'], Top['TopyE']-1.6 );
    Shape.lineTo( Top['TopxF'], Top['TopyF']-1.6 );
...
function createTopCRuler(temp_ruler, temp_ruler2){
    ...
    TopC['TopCyA'] = initialy-coo['TopCyA']-0.1+pt;
    TopC['TopCyB'] = initialy-coo['TopCyB']+pt;
    TopC['TopCyC'] = initialy-coo['TopCyC']+pt;
    TopC['TopCyD'] = initialy-coo['TopCyD']+pt;
    TopC['TopCyE'] = initialy-coo['TopCyE']+pt;
    TopC['TopCyF'] = initialy-coo['TopCyF']+pt;
    TopC['TopCyG'] = initialy-coo['TopCyG']+pt;
    TopC['TopCyH'] = initialy-coo['TopCyH']-0.1+pt;
