...
function createLock1Ruler(temp_ruler, temp_ruler2){
    ...
    Lock1['Lock1yA'] = initialy-coo['L1yB'];
...
function createLock2Ruler(temp_ruler){
    ...
    Lock2['Lock2yB'] = initialy-coo['W2yB'];
    ...
    Lock2['Lock2yJ'] = initialy-coo['W2yC'];
...
function createLock3Ruler(temp_ruler, temp_ruler2){
    ...
    Lock3['Lock3yC'] = initialy-coo['L2yB'];
    ...
    Lock3['Lock3yM'] = initialy-coo['L2yC'];
...
function createLock4Ruler(temp_ruler){
    ...
    Lock4['Lock4yE'] = initialy-coo['W2yC'];
