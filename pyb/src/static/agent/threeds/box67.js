...
function createShapes() {
    ...
    var temp_W2 = createW2Ruler();
    var temp_L2 = createL2Ruler(temp_W2);
    var axes = new THREE.AxisHelper(100);
    var temp_Ruler = createRuler(temp_L1, temp_W1, temp_L2);
    scene.add(temp_Ruler);
}
function createRuler(temp_ruler, temp_ruler2, temp_ruler3) {
