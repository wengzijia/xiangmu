...
function createShapes(){
    ...
    var temp_L1 		= createL1Ruler(temp_N, temp_PortB, temp_SafeSheB);
    ...
    var temp_L2 		= createL2Ruler(temp_Top, temp_W2, temp_Bottom);
...
function createPortB(temp_ruler){
    ...
    PortBPath.absarc(PortB['PortBxI'], PortB['PortByI'], 2.5, 270/180*Math.PI, 90/180*Math.PI, false );
    PortBPath.lineTo(PortB['PortBxJ'], PortB['PortByJ']);
    PortBPath.lineTo(PortB['PortBxK'], PortB['PortByK']);
    PortBPath.absarc(PortB['PortBxL'], PortB['PortByL'], 5, 0/180*Math.PI, 180/180*Math.PI, false );
    PortBPath.lineTo(PortB['PortBxM'], PortB['PortByM']);
    PortBPath.lineTo(PortB['PortBxN'], PortB['PortByN']);
    PortBPath.absarc(PortB['PortBxO'], PortB['PortByO'], 2.5, 90/180*Math.PI, 270/180*Math.PI, false )
...
function createPortT(){
    ...
    PortTPath.absarc(PortT['PortTxR'], PortT['PortTyR'], 2.5, 90/180*Math.PI, 270/180*Math.PI, false );
    PortTPath.lineTo(PortT['PortTxQ'], PortT['PortTyQ']);
    PortTPath.lineTo(PortT['PortTxP'], PortT['PortTyP']);
    PortTPath.absarc(PortT['PortTxO'], PortT['PortTyO'], 5, 180/180*Math.PI, 360/180*Math.PI, false );
    PortTPath.lineTo(PortT['PortTxN'], PortT['PortTyN']);
    PortTPath.lineTo(PortT['PortTxM'], PortT['PortTyM']);
    PortTPath.absarc(PortT['PortTxL'], PortT['PortTyL'], 2.5, 270/180*Math.PI, 90/180*Math.PI, false );
...
function createSafeSheTlRuler(){
    ...
    Shape.absarc( SafeSheT['SafesheTxC'], SafeSheT['SafesheTyC'], 5, 180/180*Math.PI ,270/180*Math.PI, false );
    Shape.lineTo( SafeSheT['SafesheTxC'], SafeSheT['SafesheTyC']);
...
function createSafeSheTrRuler(){
    ...
    Shape.absarc( SafeSheT['SafesheTxF'], SafeSheT['SafesheTyF'], 5, 270/180*Math.PI ,360/180*Math.PI, false );
    Shape.lineTo( SafeSheT['SafesheTxF'], SafeSheT['SafesheTyF']);
...
function createL1Ruler(temp_ruler, temp_ruler2, temp_ruler3){
    ...
    L1Ruler = changePivot(-L1['L1xE'],0,0,L1['L1xE'],0,0,mesh,remesh,0);
