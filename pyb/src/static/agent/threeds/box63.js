...
function createL1Ruler(temp_ruler, temp_ruler2, temp_ruler3){
    ...
    L1Path.absarc(L1['L1xE'], L1['L1yE'], 2.75, 0/180*Math.PI, 360/180*Math.PI, false );
    L1Path.absarc(L1['L1xF'], L1['L1yF'], 2.75, 0/180*Math.PI, 360/180*Math.PI, false );

    Shape.holes.push( L1Path );
    var mesh = addShape(Shape);
    mesh.add(temp_ruler);
    mesh.add(temp_ruler2);
    mesh.add(temp_ruler3);
...
function createBottomRuler(temp_ruler){
    ...
    Shape.lineTo( Bottom['BottomxE'], Bottom['BottomyE']+1.86 );
    Shape.lineTo( Bottom['BottomxF'], Bottom['BottomyF']+1.86 );
    Shape.lineTo( Bottom['BottomxM'], Bottom['BottomyM'] );
    Shape.lineTo( Bottom['BottomxN'], Bottom['BottomyN'] );
    Shape.lineTo( Bottom['BottomxG'], Bottom['BottomyG']+1.86 );
    Shape.lineTo( Bottom['BottomxH'], Bottom['BottomyH']+1.86 );
