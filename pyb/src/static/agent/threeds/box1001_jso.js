...
function createShapes(){
    ...
    var temp_W1 		= createW1Ruler(temp_Dust1, temp_Dust4);
    ...
    var temp_L1 		= createL1Ruler(temp_Top, temp_Bottom);
    ...
    var temp_L2 		= createL2Ruler(temp_N);

    var temp_W2 		= createW2Ruler(temp_Dust2, temp_Dust3, temp_L2);
...
function createDust3Ruler(temp_ruler){
    ...
    Dust3['Dust3xA'] = coo['W2xB'] - initialx;
    ...
    Dust3['Dust3xJ'] = coo['W2xC'] - initialx;
    ...
    Dust3['Dust3yJ'] = initialy-coo['W2yC'];
    ...
    Dust3Ruler = changePivot(0, -temp, 0, 0, temp, -0.1, mesh, remesh,0);
...
function createDust4Ruler(temp_ruler){
    ...
    Dust4['Dust4xA'] = coo['W1xB'] - initialx;
    ...
    Dust4['Dust4xJ'] = coo['W1xC'] - initialx;
    ...
    Dust4Ruler = changePivot(0, -temp, 0, 0, temp, -0.1, mesh, remesh, 0);
