...
function createShapes(){
    ...
    var temp_L1 		= createL1Ruler(temp_N, temp_Lock1, temp_SafeSheB);
...
function createSafeSheTlRuler(){
    ...
    Shape.absarc( SafeSheT['SafesheTxC'], SafeSheT['SafesheTyC'], 5, 90/180*Math.PI ,180/180*Math.PI, false );
    Shape.lineTo( SafeSheT['SafesheTxC'], SafeSheT['SafesheTyC']);
...
function createSafeSheTrRuler(){
    ...
    Shape.absarc( SafeSheT['SafesheTxF'], SafeSheT['SafesheTyF'], 5, 0/180*Math.PI ,90/180*Math.PI, false );
    Shape.lineTo( SafeSheT['SafesheTxF'], SafeSheT['SafesheTyF']);
...
function createLock1Ruler(temp_ruler, temp_ruler2){
    ...
    Lock1['Lock1yN'] = initialy-coo['Lock1yN']+pt+1;
...
function createLock2Ruler(temp_ruler){
    ...
    Lock2['Lock2yJ'] = initialy-coo['Lock2yJ']+1.5;

    Shape.moveTo( Lock2['Lock2xB'], Lock2['Lock2yB'] );
...
function createLock3Ruler(temp_ruler, temp_ruler2){
    ...
    Lock3['Lock3xM'] = coo['Lock3xM'] - initialx;

    //Lock3['Lock3yB'] = initialy-coo['Lock3yB']+1.5;
    Lock3['Lock3yC'] = initialy-coo['Lock3yC']+1.5;
    ...
    Lock3['Lock3yM'] = initialy-coo['Lock3yM']+1.5;

    Shape.moveTo( Lock3['Lock3xC'], Lock3['Lock3yC'] );
    ...
    Shape.lineTo( Lock3['Lock3xM'], Lock3['Lock3yM'] );
...
function createLock3lRuler(){
    ...
    Lock3l['Lock3xF'] = coo['Lock3xF'] - initialx;
    Lock3l['Lock3yF'] = initialy-coo['Lock3yF'];
    Lock3l['Lock3radius'] = coo['Lock3radius'];

    Shape.absarc( Lock3l['Lock3xF'], Lock3l['Lock3yF'], Lock3l['Lock3radius'], 180/180*Math.PI ,270/180*Math.PI, false );
    Shape.lineTo( Lock3l['Lock3xF'], Lock3l['Lock3yF']);
...
function createLock3rRuler(){
    ...
    Lock3r['Lock3xI'] = coo['Lock3xI'] - initialx;
    Lock3r['Lock3yI'] = initialy-coo['Lock3yI'];
    Lock3r['Lock3radius'] = coo['Lock3radius'];

    Shape.absarc( Lock3r['Lock3xI'], Lock3r['Lock3yI'], Lock3r['Lock3radius'], 270/180*Math.PI ,360/180*Math.PI, false );
    Shape.lineTo( Lock3r['Lock3xI'], Lock3r['Lock3yI']);
...
function createLock4Ruler(temp_ruler){
    ...
    Lock4['Lock4yA'] = initialy-coo['Lock4yA']+1.5;
    ...
    Lock4['Lock4yE'] = initialy-coo['Lock4yE']+1.5;
...
function createBottomRuler(temp_ruler){
    ...
    SafeKou['SafeKouxE'] = coo['SafeKouxE'] - initialx;
    SafeKou['SafeKouyE'] = initialy-coo['SafeKouyE'];
    ...
    Shape.absarc( SafeKou['SafeKouxE'], SafeKou['SafeKouyE']-0.86, 7.5, 180/180*Math.PI ,360/180*Math.PI, false );
