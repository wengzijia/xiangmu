...
var Lock1Ruler = new THREE.Group();
var Lock1lRuler = new THREE.Group();
var Lock1rRuler = new THREE.Group();
var Lock2Ruler = new THREE.Group();
var Lock2lRuler = new THREE.Group();
var Lock3Ruler = new THREE.Group();
var Lock3rRuler = new THREE.Group();
...
function createShapes(){
    ...
    var temp_L1 		= createL1Ruler(temp_N, temp_Lock1);
    ...
    var temp_L2 		= createL2Ruler(temp_Bottom, temp_W2, temp_Lock3);

    var axes            = new THREE.AxisHelper(100);


    var temp_Ruler 		= createRuler(temp_L1, temp_W1, temp_L2, temp_Dust1);
...
function createRuler(temp_ruler, temp_ruler2, temp_ruler3, temp_ruler4){
