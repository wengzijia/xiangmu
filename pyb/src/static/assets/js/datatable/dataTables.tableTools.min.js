var TableTools; (function(n, t, i) {
    var r = function(r) {
        ...
        var f = {
            ...
            nextId: 1,
            $: function(n) {
                return typeof n == "string" && (n = t.getElementById(n)),
            ...
            getDOMObjectPosition: function(n) {
                ...
                for (n.style.width !== "" && (t.width = n.style.width.replace("px", "")), n.style.height !== "" && (t.height = n.style.height.replace("px", "")); n;) t.left += n.offsetLeft,
                t.top += n.offsetTop,
                n = n.offsetParent;
                return t
            },
        ...
        return f.Client.prototype = {
            ...
            receiveEvent: function(i, r) {
                ...
                if (this.handlers[i]) for (e = 0, o = this.handlers[i].length; e < o; e++) u = this.handlers[i][e],
                typeof u == "function" ? u(this, r) : typeof u == "object" && u.length == 2 ? u[0][u[1]](this, r) : typeof u == "string" && n[u](this, r)
            }
        },
        n.ZeroClipboard_TableTools = f,
        function(n, t, r) {
            u = function(t, i) { ! this instanceof u && alert("Warning: TableTools must be initialised with the keyword 'new'");
                ...
                this.classes = n.extend(!0, {},
                u.classes),
                this.s.dt.bJUI && n.extend(!0, this.classes, u.classes_themeroller),
            ...
            u.prototype = {
                ...
                fnSelectAll: function(n) {
                    ...
                    this._fnRowSelect(n === !0 ? t.dt.aiDisplay: t.dt.aoData)
                },
                fnSelectNone: function(n) {
                    var t = this._fnGetMasterSettings();
                    this._fnRowDeselect(this.fnGetSelected(n))
                },
                fnSelect: function(n) {
                    this.s.select.type == "single" ? (this.fnSelectNone(), this._fnRowSelect(n)) : this.s.select.type == "multi" && this._fnRowSelect(n)
                },
                ...
                fnGetTitle: function(n) {
                    var t = "",
                    i;
                    return typeof n.sTitle != "undefined" && n.sTitle !== "" ? t = n.sTitle: (i = r.getElementsByTagName("title"), i.length > 0 && (t = i[0].innerHTML)),
                    "¡".toString().length < 4 ? t.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "") : t.replace(/[^a-zA-Z0-9_\.,\-_ !\(\)]/g, "")
                },
                fnCalcColRatios: function(n) {
                    for (var o = this.s.dt.aoColumns,
                    f = this._fnColumnTargets(n.mColumns), i = [], u = 0, e = 0, t = 0, r = f.length; t < r; t++) f[t] && (u = o[t].nTh.offsetWidth, e += u, i.push(u));
                ...
                _fnButtonDefinations: function(t, i) {
                    ...
                    o = t.length; r < o; r++) {
                        if (typeof t[r] == "string") {
                            if (typeof u.BUTTONS[t[r]] == "undefined") {
                            ...
                            if (typeof u.BUTTONS[t[r].sExtends] == "undefined") {
                                alert("TableTools: Warning - unknown button type: " + t[r].sExtends);
                                continue
                            }
                            e = n.extend({},
                            u.BUTTONS[t[r].sExtends], !0);
                            f = n.extend(e, t[r], !0)
                        }
                        i.appendChild(this._fnCreateButton(f, n(i).hasClass(this.classes.collection.container)))
                    }
                },
                _fnCreateButton: function(n, t) {
                    var i = this._fnButtonBase(n, t);
                    return n.sAction.match(/flash/) ? this._fnFlashConfig(i, n) : n.sAction == "text" ? this._fnTextConfig(i, n) : n.sAction == "div" ? this._fnTextConfig(i, n) : n.sAction == "collection" && (this._fnTextConfig(i, n), this._fnCollectionConfig(i, n)),
                    i
                },
                _fnButtonBase: function(n, t) {
                    ...
                    return i.className = e + " " + n.sButtonClass,
                    i.setAttribute("id", "ToolTables_" + this.s.dt.sInstance + "_" + s.buttonCounter),
                    i.appendChild(o),
                    o.innerHTML = n.sButtonText,
                    s.buttonCounter++,
                    i
                },
                _fnGetMasterSettings: function() {
                    ...
                    for (t = u._aInstances, n = 0, i = t.length; n < i; n++) if (this.dom.table == t[n].s.dt.nTable) return t[n].s
                },
                ...
                _fnCollectionHide: function(t, i) { (i === null || i.sExtends != "collection") && this.dom.collection.collection !== null && (n(this.dom.collection.collection).animate({
                        opacity: 0
                    },
                    500,
                    function() {
                ...
                _fnRowSelectConfig: function() {
                    if (this.s.master) {
                        ...
                        if (n(i.nTable).addClass(this.classes.select.table), this.s.select.type === "os") {
                            n(i.nTBody).on("mousedown.DTTT_Select", "tr",
                            function(t) {
                                if (t.shiftKey) n(i.nTBody).css("-moz-user-select", "none").one("selectstart.DTTT_Select", "tr",
                                function() {
                                    return ! 1
                                })
                            });
                            n(i.nTBody).on("mouseup.DTTT_Select", "tr",
                            function() {
                                n(i.nTBody).css("-moz-user-select", "")
                            })
                        }
                        n(i.nTBody).on("click.DTTT_Select", "tr",
                        function(r) {
                            var f = t.s.select,
                            o = t.s.dt.oInstance.fnGetPosition(this),
                            h;
                            if (this.parentNode == i.nTBody && i.oInstance.fnGetData(this) !== null) {
                                if (f.type == "os") if (r.ctrlKey || r.metaKey) t.fnIsSelected(this) ? t._fnRowDeselect(this, r) : t._fnRowSelect(this, r);
                                else if (r.shiftKey) {
                                    var u = t.s.dt.aiDisplay.slice(),
                                    e = n.inArray(f.lastRow, u),
                                    s = n.inArray(o, u);
                                    t.fnGetSelected().length === 0 || e === -1 ? u.splice(n.inArray(o, u) + 1, u.length) : (e > s && (h = s, s = e, e = h), u.splice(s + 1, u.length), u.splice(0, e));
                                    t.fnIsSelected(this) ? (u.splice(n.inArray(o, u), 1), t._fnRowDeselect(u, r)) : t._fnRowSelect(u, r)
                                } else t.fnIsSelected(this) && t.fnGetSelected().length === 1 ? t._fnRowDeselect(this, r) : (t.fnSelectNone(), t._fnRowSelect(this, r));
                                else t.fnIsSelected(this) ? t._fnRowDeselect(this, r) : f.type == "single" ? (t.fnSelectNone(), t._fnRowSelect(this, r)) : f.type == "multi" && t._fnRowSelect(this, r);
                                f.lastRow = o
                            }
                        });
                        i.oApi._fnCallbackReg(i, "aoRowCreatedCallback",
                        function(r, u, f) {
                ...
                _fnRowSelect: function(t, i) {
                    for (var s = this,
                    f = this._fnSelectData(t), h = f.length === 0 ? null: f[0].nTr, e = [], r = 0, o = f.length; r < o; r++) f[r].nTr && e.push(f[r].nTr);
                    if (this.s.select.preRowSelect === null || this.s.select.preRowSelect.call(this, i, e, !0)) {
                        for (r = 0, o = f.length; r < o; r++) f[r]._DTTT_selected = !0,
                        f[r].nTr && n(f[r].nTr).addClass(s.classes.select.row);
                        this.s.select.postSelected !== null && this.s.select.postSelected.call(this, e);
                        u._fnEventDispatch(this, "select", e, !0)
                    }
                },
                _fnRowDeselect: function(t, i) {
                    for (var s = this,
                    f = this._fnSelectData(t), h = f.length === 0 ? null: f[0].nTr, e = [], r = 0, o = f.length; r < o; r++) f[r].nTr && e.push(f[r].nTr);
                    if (this.s.select.preRowSelect === null || this.s.select.preRowSelect.call(this, i, e, !1)) {
                        for (r = 0, o = f.length; r < o; r++) f[r]._DTTT_selected = !1,
                        f[r].nTr && n(f[r].nTr).removeClass(s.classes.select.row);
                        this.s.select.postDeselected !== null && this.s.select.postDeselected.call(this, e);
                        u._fnEventDispatch(this, "select", e, !1)
                    }
                },
                _fnSelectData: function(n) {
                    ...
                    t,
                    u;
                    if (n.nodeName) r = this.s.dt.oInstance.fnGetPosition(n),
                    i.push(this.s.dt.aoData[r]);
                    else {
                ...
                _fnTextConfig: function(t, i) {
                    ...
                    i.fnSelect !== null && u._fnEventListen(this, "select",
                    function(n) {
                ...
                _fnColumnTargets: function(n) {
                    var u = [],
                    r = this.s.dt,
                    t,
                    i;
                    if (typeof n == "object") {
                        for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(!1);
                        for (t = 0, i = n.length; t < i; t++) u[n[t]] = !0
                    } else if (n == "visible") for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(r.aoColumns[t].bVisible ? !0 : !1);
                    else if (n == "hidden") for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(r.aoColumns[t].bVisible ? !1 : !0);
                    else if (n == "sortable") for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(r.aoColumns[t].bSortable ? !0 : !1);
                    else for (t = 0, i = r.aoColumns.length; t < i; t++) u.push(!0);
                    return u
                },
                ...
                _fnGetDataTablesData: function(t) {
                    ...
                    u = this.s.dt,
                    v,
                    l = new RegExp(t.sFieldBoundary, "g"),
                    y = this._fnColumnTargets(t.mColumns),
                    p = typeof t.bSelectedOnly != "undefined" ? t.bSelectedOnly: !1,
                    w,
                    h,
                    c;
                    if (t.bHeader) {
                        for (f = [], r = 0, e = u.aoColumns.length; r < e; r++) y[r] && (i = u.aoColumns[r].sTitle.replace(/\n/g, " ").replace(/<.*?>/g, "").replace(/^\s+|\s+$/g, ""), i = this._fnHtmlDecode(i), f.push(this._fnBoundData(i, t.sFieldBoundary, l)));
                        s.push(f.join(t.sFieldSeperator))
                    }
                    for (w = this.fnGetSelected(), p = this.s.select.type !== "none" && p && w.length !== 0, h = u.oInstance.$("tr", t.oSelectorOpts).map(function(t, i) {
                        return p && n.inArray(i, w) === -1 ? null: u.oInstance.fnGetPosition(i)
                    }).get(), o = 0, b = h.length; o < b; o++) {
                        for (v = u.aoData[h[o]].nTr, f = [], r = 0, e = u.aoColumns.length; r < e; r++) y[r] && (c = u.oApi._fnGetCellData(u, h[o], r, "display"), t.fnCellRender ? i = t.fnCellRender(c, r, v, h[o]) + "": typeof c == "string" ? (i = c.replace(/\n/g, " "), i = i.replace(/<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi, "$1$2$3"), i = i.replace(/<.*?>/g, "")) : i = c + "", i = i.replace(/^\s+/, "").replace(/\s+$/, ""), i = this._fnHtmlDecode(i), f.push(this._fnBoundData(i, t.sFieldBoundary, l)));
                        s.push(f.join(t.sFieldSeperator));
                        t.bOpenRows && (a = n.grep(u.aoOpenRows,
                        function(n) {
                            return n.nParent === v
                        }), a.length === 1 && (i = this._fnBoundData(n("td", a[0].nTr).html(), t.sFieldBoundary, l), s.push(i)))
                    }
                    if (t.bFooter && u.nTFoot !== null) {
                        for (f = [], r = 0, e = u.aoColumns.length; r < e; r++) y[r] && u.aoColumns[r].nTf !== null && (i = u.aoColumns[r].nTf.innerHTML.replace(/\n/g, " ").replace(/<.*?>/g, ""), i = this._fnHtmlDecode(i), f.push(this._fnBoundData(i, t.sFieldBoundary, l)));
                        s.push(f.join(t.sFieldSeperator))
                    }
                    return s.join(this._fnNewline(t))
                },
                ...
                _fnPrintStart: function(i) {
                    ...
                    i.bShowAll && (u._iDisplayStart = 0, u._iDisplayLength = -1, u.oApi._fnCalculateEnd && u.oApi._fnCalculateEnd(u), u.oApi._fnDraw(u)); (u.oScroll.sX !== "" || u.oScroll.sY !== "") && (this._fnPrintScrollStart(u), n(this.s.dt.nTable).bind("draw.DTTT_Print",
                    function() {
                    ...
                    i.sMessage && n("<div/>").addClass(this.classes.print.message).html(i.sMessage).prepend("body");
                    this.s.print.saveScroll = n(t).scrollTop();
                    t.scrollTo(0, 0);
                    n(r).bind("keydown.DTTT",
                    function(n) {
                ...
                _fnPrintEnd: function() {
                    ...
                    u = this.s.print,
                    f = this.dom.print;
                    this._fnPrintShowNodes(); (i.oScroll.sX !== "" || i.oScroll.sY !== "") && (n(this.s.dt.nTable).unbind("draw.DTTT_Print"), this._fnPrintScrollEnd());
                    t.scrollTo(0, u.saveScroll);
                    f.message !== null && (r.body.removeChild(f.message), f.message = null);
                ...
                _fnPrintShowNodes: function() {
                    for (var n = this.dom.print.hidden,
                    t = 0,
                    i = n.length; t < i; t++) n[t].node.style.display = n[t].display;
                    n.splice(0, n.length)
                },
                _fnPrintHideNodes: function(t) {
                    for (var f, e = this.dom.print.hidden,
                    u = t.parentNode,
                    r = u.childNodes,
                    i = 0,
                    o = r.length; i < o; i++) r[i] != t && r[i].nodeType == 1 && (f = n(r[i]).css("display"), f != "none" && (e.push({
                        node: r[i],
                        display: f
            ...
            u._aInstances = [];
            u._aListeners = [];
            u.fnGetMasters = function() {
                for (var t = [], n = 0, i = u._aInstances.length; n < i; n++) u._aInstances[n].s.master && t.push(u._aInstances[n]);
                return t
            };
            u.fnGetInstance = function(n) {
                typeof n != "object" && (n = r.getElementById(n));
                for (var t = 0,
                i = u._aInstances.length; t < i; t++) if (u._aInstances[t].s.master && u._aInstances[t].dom.table == n) return u._aInstances[t];
                return null
            };
            u._fnEventListen = function(n, t, i) {
                u._aListeners.push({
                    that: n,
                    type: t,
                    fn: i
            ...
            u._fnEventDispatch = function(n, t, i, r) {
                for (var e = u._aListeners,
                f = 0,
                o = e.length; f < o; f++) n.dom.table == e[f].that.dom.table && e[f].type == t && e[f].fn(i, r)
            };
            u.buttonBase = {
                sAction: "text",
                sTag: "default",
            ...
            u.BUTTONS = {
                ...
                u.buttonBase, {
                    ...
                    fnComplete: function(n, t, i, r) {
                        var u = r.split("\n").length,
                        f = this.s.dt.nTFoot === null ? u - 1 : u - 2,
                        e = f == 1 ? "": "s";
                        this.fnInfo("<h6>Table copied<\/h6><p>Copied " + f + " row" + e + " to the clipboard.<\/p>", 1500)
                    }
                }),
                pdf: n.extend({},
                u.buttonBase, {
            ...
            u.prototype.CLASS = "TableTools";
            u.version = "2.2.0-dev";
            n.fn.dataTable.Api && n.fn.dataTable.Api.register("tabletools()",
            function() {
                var n = null;
                return this.context.length > 0 && (n = u.fnGetInstance(this.context[0].nTable)),
                n
            });
            typeof n.fn.dataTable == "function" && typeof n.fn.dataTableExt.fnVersionCheck == "function" && n.fn.dataTableExt.fnVersionCheck("1.9.0") ? n.fn.dataTableExt.aoFeatures.push({
                fnInit: function(n) {
                    var t = n.oInit,
                    r = t.tableTools || t.oTableTools || {},
                    i = new u(n.oInstance, r);
                    return u._aInstances.push(i),
                    i.dom.container
                },
                cFeature: "T",
                sFeature: "TableTools"
            }) : alert("Warning: TableTools requires DataTables 1.9.0 or newer - www.datatables.net/download");
            n.fn.DataTable.TableTools = u
        } (jQuery, n, t),
        typeof r.fn.dataTable == "function" && typeof r.fn.dataTableExt.fnVersionCheck == "function" && r.fn.dataTableExt.fnVersionCheck("1.9.0") ? r.fn.dataTableExt.aoFeatures.push({
            fnInit: function(n) {
                var i = typeof n.oInit.oTableTools != "undefined" ? n.oInit.oTableTools: {},
                t = new u(n.oInstance, i);
                return u._aInstances.push(t),
                t.dom.container
            },
            cFeature: "T",
            sFeature: "TableTools"
        }) : alert("Warning: TableTools 2 requires DataTables 1.9.0 or newer - www.datatables.net/download"),
        r.fn.dataTable.TableTools = u,
        r.fn.DataTable.TableTools = u,
        u
    };
    typeof define == "function" && define.amd ? define("datatables-tabletools", ["jquery", "datatables"], r) : jQuery && !jQuery.fn.dataTable.TableTools && r(jQuery, jQuery.fn.dataTable)
})(window, document);
/*
