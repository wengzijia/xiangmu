...
var InitiateaddressDataTable = function () {
    return {
        init: function () {
...
var InitiateorderDataTable = function () {
    return {
        init: function () {
...
var InitiateofferDataTable = function () {
    return {
        init: function () {
            var oTable = $('#offertable').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "aaSorting": [],
                "aLengthMenu": [
                   [10, 20, 30, -1],
...
var InitiateaptitudeDataTable = function () {
    return {
        init: function () {
            var oTable = $('#aptitudetable').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "aaSorting": [],
                "aLengthMenu": [
                   [10, 20, 30, -1],
...
var InitiatepromotionDataTable = function () {
    return {
        init: function () {
...
var InitiateinvoiceDataTable = function () {
    return {
        init: function () {
            var oTable = $('#promotiontable').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
...
var InitiatebonusDataTable = function () {
    return {
        init: function () {
            var oTable = $('#bonustable').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "aaSorting": [],
                "aLengthMenu": [
                   [10, 20, 30, -1],
...
var InitiateusebonusDataTable = function () {
    return {
        init: function () {
            var oTable = $('#usebonustable').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "aaSorting": [],
                "aLengthMenu": [
                   [10, 20, 30, -1],
...
var InitiatenobonusDataTable = function () {
    return {
        init: function () {
            var oTable = $('#nobonustable').dataTable({
                "sDom": "Tflt<'row DTTTFooter'<'col-sm-6'i><'col-sm-6'p>>",
                "aaSorting": [],
                "aLengthMenu": [
                   [10, 20, 30, -1],
