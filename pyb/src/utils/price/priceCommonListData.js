...
export const cartCustomCommonList = [
  ...
  },
  {
    ...
    code: 'YSSL',
    id: 2,
    attrList: [{ id: 8, code: 'YSSL', defaultValue: '0', suffix: '个', name: '个', inputTips: '个', groupId: 2 }]
  }
];
/**
 * 卡盒自定义公用数据
...
export const hardcoverBoxCommonList = [
  {
    ...
    id: 1,
    attrList: [
      { id: 1, code: 'goodAl', suffix: 'x', name: '内长', inputTips: '内长', groupId: 1, min: 45, max: 9999 },
      { id: 2, code: 'goodAw', suffix: 'x', name: '内宽', inputTips: '内宽', groupId: 1, min: 45, max: 9999 },
      { id: 3, code: 'goodAd', suffix: 'x', name: '内高', inputTips: '内高', groupId: 1, min: 20, max: 250 }
    ]
  },
  {
    groupType: 'input',
    ...
    id: 3,
    attrList: [
      { id: 10, code: 'goodAl', suffix: 'x', name: '外长', inputTips: '外长', groupId: 1 },
      { id: 11, code: 'goodAw', suffix: 'x', name: '外宽', inputTips: '外宽', groupId: 1 },
      { id: 12, code: 'goodAd', suffix: 'x', name: '外高', inputTips: '外高', groupId: 1 }
    ]
  },
  {
    groupType: 'input',
    ...
    code: 'YSSL',
    id: 2,
    attrList: [{ id: 8, code: 'YSSL', defaultValue: '20', suffix: '个', name: '个', inputTips: '个', groupId: 2, min: 20, max: 99999 }]
  }
];
/**
 * 公用部分list数据
...
export const pitSbhCommonList = [
  ...
  },
  {
    ...
    id: 2,
    attrList: [
      { id: 3, code: 'goodAl', suffix: 'x', name: '长', inputTips: '长', groupId: 1 },
      { id: 4, code: 'goodAw', suffix: 'x', name: '宽', inputTips: '宽', groupId: 1 }
    ]
  },
  {
    groupType: 'input',
